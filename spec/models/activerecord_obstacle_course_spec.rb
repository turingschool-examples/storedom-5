...
describe 'ActiveRecord Obstacle Course' do
  ...
  it 'finds order id of smallest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # order_1 = Order.all.order(amount: :asc).first
  ...
  it 'finds order id of largest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
      order_15 = Order.select(:id).order(amount: :desc).first
    # ------------------------------------------------------------
  ...
  it 'should return all items except items: 3, 4 & 5' do
    ...
    # ------------------ Using ActiveRecord ----------------------
      items = Item.where.not(name: items_not_included.map(&:name))
    # ------------------------------------------------------------
