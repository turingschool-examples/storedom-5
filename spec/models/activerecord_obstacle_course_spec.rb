...
describe 'ActiveRecord Obstacle Course' do
  ...
  it 'returns the sorted names of items for a user order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items_for_user_3_third_order = Order.where('orders.user_id=?', user_3).offset(2).limit(1).first.items.pluck(:name)
    # ------------------------------------------------------------
  ...
  it 'returns the average amount for all orders for one user' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    average = Order.where('orders.user_id=?', user_3).average(:amount)
    # ------------------------------------------------------------
  ...
  it 'calculates the total sales for all but one user' do
    ...
    # ------------------ Using ActiveRecord ---------------------
    total_sales = Order.all.where('user_id != 2').sum(:amount)
    # -----------------------------------------------------------
  ...
  it 'returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.joins(:order_items).where('order_items.item_id=?', item_4).where('orders.user_id=?', user_2)
    # -----------------------------------------------------------
